...
import BenfitsSectionCard from './BenfitsSectionCard'
        ...
        <div className="flex items-center justify-center w-full bg-cover bg-center p-4 md:p-12 flex-col">
          ...
          <div className="grid relative grid-cols-1 md:grid-cols-3 w-full overflow-hidden items-center pb-8 pt-8 gap-5">
            ...
            <div data-aos="fade-up" data-aos-delay="0">
              <BenfitsSectionCard icon={'icon-optimize-time.svg'} title={'Optimize Time & Effort'} description={<>Automate routine operations to free up time for <br />strategic, high-impact initiatives.</>} />
            </div>

            <div className="rounded-2xl hidden md:block bg-linear-to-b from-[#01040E] to-[#0A112B] w-full h-full"></div>

            <div data-aos="fade-up" data-aos-delay="150">
              <BenfitsSectionCard icon={'icon-boost-productivity.svg'} title={'Boost Productivity'} description={<>Eliminate process bottlenecks and ensure <br /> alignment across departments</>} />
            </div>
            ...
            <div data-aos="fade-up" data-aos-delay="0">
              <BenfitsSectionCard icon={'icon-data-driven.svg'} title={'Data-Driven Decisions'} description={<>Leverage real-time analytics to guide planning <br />and execution with greater clarity.</>} />
            </div>

            <div className="rounded-2xl hidden md:block bg-linear-to-t from-[#010924] to-[#0A112B] w-full h-full"></div>

            <div data-aos="fade-up" data-aos-delay="150">
              <BenfitsSectionCard icon={'icon-remote-productivity.svg'} title={'Remote Productivity'} description={<>Secure cloud access empowers teams to <br /> collaborate effectively from any location.</>} />
            </div>
